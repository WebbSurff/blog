...
const closeInfo = document.querySelector('.warning__close');
...
window.onload = function () {
    ...
    function documentActions(e) {
        ...
        if (window.innerWidth > 992 && isMobile.any()) {
            if (targetElement.classList.contains('menu__open')) {
            ...
            if (!targetElement.closest('.menu__item') && document.querySelectorAll('.menu__item.hover').length > 0) {
                _removeClasses(document.querySelectorAll('.menu__item.hover'), "hover");
            }
        }
    }
}
